...
class CountDownService : Service() {
    ...
    companion object {
        ...
        const val IS_COUNTDOWN_TIMER_RUNNING = "IS_COUNTDOWN_TIMER_RUNNING"

        // Intent Actions
        const val COUNTDOWN_TIMER_TICK = "COUNTDOWN_TIMER_TICK"
        const val COUNTDOWN_TIMER_STATUS = "COUNTDOWN_TIMER_STATUS"
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val action = intent?.getStringExtra(COUNTDOWN_TIMER_ACTION)!!
...
//        stopForeground(true)
    ...
    private fun startStopwatch() {
        ...
        stopwatchTimer.scheduleAtFixedRate(object : TimerTask() {
            override fun run() {
                ...
                stopwatchIntent.action = COUNTDOWN_TIMER_TICK
    ...
    * */
    private fun sendStatus() {
        ...
        statusIntent.action = COUNTDOWN_TIMER_STATUS
        statusIntent.putExtra(IS_COUNTDOWN_TIMER_RUNNING, isStopWatchRunning)
